...
{% assign entries = site.pages | where_exp: "page", "page.dir contains '/knowledge/channent/'" | where: "public", true | where_exp: "page", "page.url != '/knowledge/channent/'" | sort: "date" | reverse %}
{% if entries.size > 0 %}
{% for page in entries %}
